<script setup lang="ts">
  ...
  const isBugValid = computed(() => {
    const f = forms.bug
    return (
      (/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(f.email) || f.testerEmail.trim().length > 0) &&
  ...
  const isValid = computed(() => {
    switch (type.value) {
      ...
      case 'tester':
        return isTesterValid.value
      case 'developer':
        return isDeveloperValid.value
      case 'bug':
...
<template>
  <div class="contact-form-select">
    ...
    <div class="contact-form-select__type">
      ...
      >
        <option value="general">
          {{ $t('contact.form.type.general') }}
        </option>
        <option value="tester">
          {{ $t('contact.form.type.tester') }}
        </option>
        <option value="developer">
          {{ $t('contact.form.type.developer') }}
        </option>
        <option value="bug">
    ...
    >
      ...
      <button class="contact-form-select__reset-btn" type="button" @click="status = 'idle'">
    ...
    <form v-else class="contact-form-select__fields" novalidate @submit.prevent="submitForm">
      ...
      <fieldset
        v-if="type === 'general'"
        class="contact-form-select__fieldset"
        data-testid="contact-form-general"
      >
        <legend class="contact-form-select__legend">
          {{ $t('contact.form.type.general') }}
        </legend>
      ...
      <!-- TESTADOR -->
      <fieldset
        v-else-if="type === 'tester'"
        class="contact-form-select__fieldset"
        data-testid="contact-form-tester"
      >
        <legend class="contact-form-select__legend">
          {{ $t('contact.form.type.tester') }}
        </legend>
        ...
        <div class="contact-form-select__group">
          ...
          <div class="contact-form-select__checkbox-group">
            <label v-for="focus in TESTER_FOCUS" :key="focus" class="contact-form-select__checkbox">
              <input v-model="forms.tester.focus" type="checkbox" :value="focus" />
        ...
        <div class="contact-form-select__group">
          ...
          <div class="contact-form-select__file-upload">
            ...
            />
            <label
              v-if="forms.tester.avatarPreview"
              for="tester-avatar"
              class="contact-form-select__file-preview"
            >
              <img :src="forms.tester.avatarPreview" :alt="$t('contact.form.avatarPreview')" />
              <button
                type="button"
                class="contact-form-select__file-remove"
                aria-label="{{ $t('contact.form.removeAvatar') }}"
                @click="removeFile('avatar')"
              >
      ...
      <!-- DESENVOLVEDOR -->
      <fieldset
        v-else-if="type === 'developer'"
        class="contact-form-select__fieldset"
        data-testid="contact-form-developer"
      >
        <legend class="contact-form-select__legend">
          {{ $t('contact.form.type.developer') }}
        </legend>
        ...
        <div class="contact-form-select__group">
          ...
          <div class="contact-form-select__checkbox-group">
            <label v-for="area in DEV_AREAS" :key="area" class="contact-form-select__checkbox">
              <input v-model="forms.developer.areas" type="checkbox" :value="area" />
              <span>{{ area }}</span>
            </label>
          </div>
        </div>
        ...
        <div class="contact-form-select__group">
          ...
          <div class="contact-form-select__file-upload">
            ...
            />
            <label
              v-if="forms.developer.avatarPreview"
              for="dev-avatar"
              class="contact-form-select__file-preview"
            >
      ...
      >
        ...
        <div class="contact-form-select__group">
          ...
          >
            <option value="bug">
              {{ $t('contact.form.reportType.bug') }}
            </option>
            <option value="feature">
              {{ $t('contact.form.reportType.feature') }}
            </option>
            <option value="other">
              {{ $t('contact.form.reportType.other') }}
            </option>
          </select>
        </div>
        ...
        <div class="contact-form-select__group">
          ...
          <div class="contact-form-select__file-upload">
            ...
            />
            <label
              v-if="forms.bug.attachmentPreview"
              for="bug-attachment"
              class="contact-form-select__file-preview"
            >
