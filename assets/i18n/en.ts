export default {
  ...
  notifyModal: {
    ...
    subtitle: "Enter your email and we'll let you know as soon as the mobile app is available.",
    placeholder: 'your@email.com',
    button: 'Notify on launch',
    loading: 'Sending...',
    success: "All set! You'll be notified as soon as we launch.",
    errors: {
  ...
  releases: {
    metaTitle: 'Release Notes — PIANO LouvorJA',
    metaDescription: 'Track the latest versions, improvements, and fixes of PIANO LouvorJA.',
    title: 'Release Notes',
    subtitle: 'Track the latest versions, improvements, and fixes of the project.',
    loading: 'Loading release notes...',
    error: 'Could not load release notes. Please try again later.',
    noReleases: 'No versions found.',
    latest: 'Latest',
    highlights: 'Highlights',
    pullRequests: 'Changes',
    changelog: 'Changelog',
    viewOnGithub: 'View on GitHub',
    allVersions: 'See all versions on GitHub',
    products: {
      web: 'Web',
      desktop: 'Desktop',
      mobile: 'Mobile',
