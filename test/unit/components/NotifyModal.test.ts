...
describe('NotifyModal', () => {
  ...
  it('shows translated error message when status is error with service-unavailable code', async () => {
  ...
  it('shows translated error message for already-subscribed code', async () => {
    mockStatus.value = 'error'
  ...
  it('shows translated error message for invalid-email code', async () => {
    mockStatus.value = 'error'
  ...
  it('shows translated error message for rate-limited code', async () => {
    mockStatus.value = 'error'
